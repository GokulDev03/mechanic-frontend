...
//     wind: "/ac-repair-theni",
//     box: "/refrigerator-repair-theni",
//     waves: "/washing-machine-repair-theni",
//     tv: "/tv-repair-theni",
//   };
...
//       {/* Image + Title */}
//       <Link href={servicePages[service.icon] || "/services"}>
...
//             <p
//               className={`text-white/75 text-xs mt-1 leading-relaxed drop-shadow ${
//                 showFullDesc ? 'line-clamp-3' : 'line-clamp-2'
//               }`}
//             >
//               {desc}
//             </p>
  ...
  return (
    <div className="card overflow-hidden flex flex-col group">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100 bg-white">
        ...
        <Link
          href={`/booking?service=${service.id}`}
          className="flex items-center gap-1 bg-amber-500 hover:bg-amber-600 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors"
        >
          {t.services.bookNow}
          <ChevronRight className="w-4 h-4" />
        </Link>
